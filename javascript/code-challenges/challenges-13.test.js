...
const sortByChildren = (charArray) => {
  ...
  return charArray.sort((a, b) => {
    let childNum = a.children.length - b.children.length;
...
const containsWorld = (input) => {
  ...
  return pattern.test(input) && input.toLowerCase() !== 'world';
};

let hasWorld = 'hello world';
let hasCapWorld = 'Hello World';
let hasNot = 'hello everyone';
console.log(containsWorld(hasWorld));
console.log(containsWorld(hasCapWorld));
console.log(containsWorld(hasNot));
...
const capitalResult = 'We only want to Return the Words that begin With a capital Letter';
console.log(isCapitalized(capitalResult));

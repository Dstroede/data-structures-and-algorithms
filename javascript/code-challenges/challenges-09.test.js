...
let numbers= [4, 2, 7, 5, 9, 2];
let findMax = maxInArray(numbers);
console.log(findMax);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
let courseInfoKeys = getCourseKeys(courseInfo);
...
let object = { class: '301' };
let values = checkValues(object);
console.log(values);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const updateNumbers = (obj) => {
  // Solution code here...
  let contacts = Object.entries(obj);
  let newContacts =contacts.map(([name,phoneNumber])=>{
...
let newFormat= updateNumbers(phoneNumbers);
...
let houses = getHouses(characters);
console.log(houses);
...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  let obj = arr.find(person => person.name === character);

...
let arr = [2, 4, 5, -7, 0];
let newArray= raisedToTheThird(arr);
...
const addOne = (arrTwo) => {
  let arrAdd = arrTwo.map(num => num +1);
  // Solution code here...
  return arrAdd;
};

let arr2 = addOne(arrTwo);
console.log(arr2);
...
const addQuestion = (arrThree) => {
  // Solution code here...
  let arrQ = arrThree.map(num => num +'?');
  // Solution code here...
  return arrQ;
};
let arrThree = ['hello', '301', 'students'];
let arr3 = addOne(arrThree);
console.log(arr3);

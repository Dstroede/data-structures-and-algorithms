...
console.log(transformToLis(object));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const count = (target, input) => {
  // Solution code here...
  return input.reduce((add, arr)=> {
    let count = arr.filter((num)=> num === target).length;
    return add + count;
  }, 0);
};
const numsArr = [[1, 3, 5, 7, 9], [5, 5, 5], [1, 2, 3]];
const targetNum = 5;
console.log(count(targetNum, numsArr));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
let addArr = [[1, 2, 3, 4, 5], [6, 7, 2, 4, 5, 7], [9, 2, 3, 6,]];
console.log(totalSum(addArr));
...
let fiveArr = [[10, 20, 5, 4], [5, 6, 7, 9], [1, 10, 3]];
console.log(divisibleByFiveTwoToThePower(fiveArr));
...
let findShortest = (data) => {
  ...
  let shorty = data
    ...
    .reduce((newSmallest, currentChar)=> {
      let smallest= Number(newSmallest.height);
      let currentHeight = Number(currentChar.height);

      return currentHeight < smallest ? currentChar : newSmallest;
    });
  return shorty.name;
};

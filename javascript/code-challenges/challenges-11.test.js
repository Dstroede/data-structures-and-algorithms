...
console.log(longestString(strArray2));
...
const firstLetters = (arr) => {
  // Solution code here...
  let result = arr.map((str) => str.charAt(0));
  return result;
};
...
const smileWords = ['things', 'apple (:)', ':)banana', 'missing that thing', 'cant:)aloupe'];
console.log(findHappiness(smileWords));
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  return arr.map((phoneNumbers) => {
    let number = phoneNumbers.replace(/\D/g,'');
    return number;
  });
};
...
let findOddNums = '0123456789';
let findOddLetters = 'abcd';
let singleString = 'a';
let emptyString = '';

console.log(onlyOddChars(findOddNums));
console.log(onlyOddChars(findOddLetters));
console.log(onlyOddChars(singleString));
console.log(onlyOddChars(emptyString));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const sWords = ['things', 'apple (:)', ':)banana', 'missing that thing', 'cant:)aloupe'];
console.log(allHappy(sWords));

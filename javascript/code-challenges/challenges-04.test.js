...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  let animal= arr.map(callback);
  return animal;
};
const arr = ['BeAr', 'lIon'];

updateAnimal(arr,upper)[0];
updateAnimal(arr,upper)[1];
console.log(updateAnimal(arr,upper)[0]);
console.log(updateAnimal(arr,upper)[1]);
...
let arrDos = ['able', 'Bob'];
let nameSorted= sortNames(arrDos);
...
let arrTres = [8, 3, 2, 9, 12, 1, 115];
let numSorted= sortNumbers(arrTres);
...
const arrCuatro = [3,4,5,6,7];
let numsSorted= sortBackwards(arrCuatro);
...
let arrCinco = ['alphabet', 'Zebra', 'Alphabet', 'carrot'];
let wordSort= alphabetize(arrCinco);
...
const sortByPrice = (arrSeis) => {
  // Solution code here...
  arrSeis.sort((a,b)=> a.price-b.price);
...
let sortedArr = sortByPrice(arrSeis);

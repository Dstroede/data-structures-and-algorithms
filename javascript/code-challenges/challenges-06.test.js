...
const getNames = (arr) => {
  ...
  return arr.map((person) =>
    person.name.split('').reduce((a, b) => {
      return b + a;
    }, '')
  );
};
let answerOne= getNames(arr);
...
const appendTheEnd = (a) => {
  // Solution code here...
  let addWords = a + ' The end.';
  return addWords;
};
let b = appendTheEnd(a);
console.log(b);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
------------------------------------------------------------------------------------------------ */
let arrThree = ['Yes', 'it', 'is'];
const appendFirstToLast = (arr) => {
  // Solution code here...
  let firstNum = arr[0];
  arr.push(firstNum);
};
appendFirstToLast(arrThree);
